...
- `skills/sigil`: host-neutral coding-agent skill with format guidance,
  standards-aware authoring guidance, incremental brownfield adoption,
  deterministic proposal/acceptance workflow, and implementation handoff
  preparation. Version 0.7.1 is distributed as a standalone repository skill

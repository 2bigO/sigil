...
Exclude language syntax, code literals, URLs and concept identifiers as automatic
candidates. Give each candidate its actual occurrences, proposed meaning and
appropriate workspace or bounded-context scope. A no-candidate conclusion needs
prose inspection, not a diagnostic count. Ordinary unambiguous words need no entry.

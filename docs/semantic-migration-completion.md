...
`ff82926` and currently ends at `5fbff41`:
...
| S08 | `3fb4430`, `bf2ab6e`, `10244a6`, `136f8fc`, `19507a1`, `cdf5b31`, `9da0997`, `81fa824`, `73bbb66`, `be5f258`, `5121766`, `84ffcc9`, `5fbff41` | Native distribution builder, standalone bootstrap, offline Linux archive gate, published-consumer fixture, source-independent artifact-consumer matrix, per-target installer consumer, per-target published-runtime consumer, native Windows archive creation, pre-pulled offline smoke image, checksum-retention installer checks, CI matrix and immutable installers |
